...
from gendiff.parse import read_file, get_format, get_parse
...
def generate_diff(data1, data2, formatter='stylish'):
    data1 = get_parse(read_file(data1), get_format(data1))
    data2 = get_parse(read_file(data2), get_format(data2))
